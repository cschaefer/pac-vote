...
public class OauthValidationResponse {
    ...
    public OauthValidationResponse(int code, String message, Map<String, String> headers, String body, InputStream stream) {
        this.code = code;
    ...
    OauthValidationResponse(HttpURLConnection connection) throws IOException {
        try {
            connection.connect();
